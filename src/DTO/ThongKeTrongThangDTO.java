 ...
 * @author robot
 */
public class ThongKeTrongThangDTO{
    private Date ngay;
    private int chiphi;
    private int doanhthu;
    private int loinhuan;

    public ThongKeTrongThangDTO(Date ngay, int chiphi, int doanhthu, int loinhuan) {
        this.ngay = ngay;
        this.chiphi = chiphi;
    ...
    public boolean equals(Object obj) {
        ...
        final ThongKeTrongThangDTO other = (ThongKeTrongThangDTO) obj;
